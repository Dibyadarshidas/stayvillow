...
export default function PanoramicMountainVillaPage() {
  ...
  const propertyInfo = {
    ...
    reviews: 88,
    price: "₹14,000 - ₹20,000",
    description: "Enjoy stunning 360° views of the Himalayan range from this luxury villa. Features glass-walled living areas, mountain-view bedrooms, and outdoor jacuzzi.",
    images: [
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1500&q=90",
      "https://images.unsplash.com/photo-1502005097973-6a7082348e28?auto=format&fit=crop&w=1500&q=90",
      "https://images.unsplash.com/photo-1563911302283-d2bc129e7570?auto=format&fit=crop&w=1500&q=90",
      "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=1500&q=90",
      "https://images.unsplash.com/photo-1506974210756-8e1b8985d348?auto=format&fit=crop&w=1500&q=90",
    ]
  };
          ...
          <div className="md:col-span-2">
            ...
            <div className="p-6 bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl border border-cyan-100 mb-6">
              ...
              <p className="text-gray-700 mb-4">
                Take a virtual tour of this mountain paradise before booking! Our 360° panoramic view lets you explore the glass-walled living areas, mountain-view bedrooms, and outdoor jacuzzi as if you were there in person.
              </p>
              <Link
                href="/virtual-tours/panoramic-mountain-villa/vr-tour"
