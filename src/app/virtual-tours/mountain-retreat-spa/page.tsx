...
export default function MountainRetreatSpaPage() {
          ...
          <div className="md:col-span-2">
            ...
            <div className="p-6 bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl border border-cyan-100 mb-6">
              ...
              <p className="text-gray-700 mb-4">
                Discover our spa retreat through an immersive virtual tour! Explore the indoor heated pool, cozy fireplaces, and meditation spaces as if you were there in person.
              </p>
              <Link
                href="/virtual-tours/mountain-retreat-spa/vr-tour"
