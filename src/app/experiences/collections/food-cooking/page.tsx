...
// Sample experiences data for Food & Cooking collection
const foodExperiences = [
  ...
  },
  {
    ...
    description: "Explore Mumbai's vibrant street food scene with a local food expert. Sample iconic dishes like vada pav, pav bhaji, and chaat in the city's most authentic spots.",
    price: "₹1,800",
    duration: "4 hours",
    rating: 4.9,
    reviews: 142,
  ...
  {
    id: 12,
    title: "South Indian Cooking Workshop",
    description: "Learn to prepare authentic South Indian dishes like dosas, idlis, and sambhar from expert home cooks. Discover the secrets of tempering spices and making perfect rice dishes.",
    price: "₹2,000",
    duration: "3 hours",
    rating: 4.8,
    reviews: 76,
    image: "https://images.unsplash.com/photo-1589647363585-f4a7d3877b10?w=800&auto=format&fit=crop&q=80",
...
export default function FoodCookingPage() {
  const [searchTerm, setSearchTerm] = useState('');
  
  // Filter experiences based on search
  const filteredExperiences = foodExperiences.filter(exp => {
    return searchTerm === '' || 
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="relative h-[250px] md:h-[300px] rounded-2xl overflow-hidden mb-8">
        <Image
          src="https://images.unsplash.com/photo-1556911073-a517e752729c?w=1600&auto=format&fit=crop&q=80"
          alt="Food & Cooking Experiences"
          fill
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-12">
          <div className="max-w-lg">
            <h1 className="text-white text-2xl md:text-3xl font-bold mb-2">Food & Cooking</h1>
            <p className="text-white/90">Delicious culinary adventures across India's diverse food landscape</p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        <nav className="flex text-sm text-gray-600">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900 font-medium">Food & Cooking</span>
        </nav>
      </div>
      
      {/* Description */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Food & Cooking Experiences</h2>
        <p className="text-gray-600 max-w-3xl">
          Discover the rich flavors and culinary traditions of India through hands-on cooking classes, food tours, and farm visits. Learn authentic recipes, explore local markets, and enjoy delicious meals prepared with fresh ingredients.
        </p>
      </div>
