...
// Sample experiences data for Cultural Immersion collection
const culturalExperiences = [
  ...
  },
  {
    ...
    description: "Learn the basics of classical Indian dance forms like Bharatanatyam or Kathak from professional dancers. Perfect for beginners and cultural enthusiasts.",
    price: "₹2,000",
    duration: "3 hours",
    rating: 4.8,
    reviews: 65,
    image: "https://images.unsplash.com/photo-1503789146722-cf137a3c0fea?w=800&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    description: "Explore the narrow lanes of Old Delhi with a local historian. Visit historical monuments, sample street food, and learn about the area's rich cultural heritage.",
    price: "₹1,500",
    duration: "4 hours",
    rating: 4.9,
    reviews: 92,
...
export default function CulturalImmersionPage() {
  ...
  const filteredExperiences = culturalExperiences.filter(exp => {
    return searchTerm === '' || 
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="relative h-[250px] md:h-[300px] rounded-2xl overflow-hidden mb-8">
        <Image
          src="https://images.unsplash.com/photo-1561704061-7b246d89655c?w=1600&auto=format&fit=crop&q=80"
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-12">
          <div className="max-w-lg">
            <h1 className="text-white text-2xl md:text-3xl font-bold mb-2">Cultural Immersion</h1>
            <p className="text-white/90">Authentic experiences that connect you with India's rich cultural heritage</p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        <nav className="flex text-sm text-gray-600">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900 font-medium">Cultural Immersion</span>
        </nav>
      </div>
      
      {/* Description */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Cultural Immersion Experiences</h2>
        <p className="text-gray-600 max-w-3xl">
          Dive deep into India's rich cultural heritage with our handpicked experiences. From traditional cooking classes to spiritual ceremonies, these activities offer authentic connections with local traditions, arts, and communities.
        </p>
      </div>
